...
describe('DomainErrorTranslator', () => {
  it('should translate error correctly', () => {
    ...
    expect(
      DomainErrorTranslator.translate(
        new Error('REGISTER_THREAD.NOT_CONTAIN_NEEDED_PROPERTY')
      )
    ).toStrictEqual(
      new InvariantError(
    ...
    expect(
      DomainErrorTranslator.translate(
        new Error('REGISTER_THREAD.NOT_MEET_DATA_TYPE_SPECIFICATION')
      )
    ).toStrictEqual(
      new InvariantError(
    ...
    expect(
      DomainErrorTranslator.translate(
        new Error('REGISTER_THREAD_COMMENT.NOT_CONTAIN_NEEDED_PROPERTY')
      )
    ).toStrictEqual(
      new InvariantError(
    ...
    expect(
      DomainErrorTranslator.translate(
        new Error('REGISTER_THREAD_COMMENT.NOT_MEET_DATA_TYPE_SPECIFICATION')
      )
    ).toStrictEqual(
      new InvariantError(
